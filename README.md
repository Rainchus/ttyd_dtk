...
- Clone the repository:
  ...
  ```sh
  git clone https://github.com/Rainchus/ttyd_dtk
  ```

- Using [Dolphin Emulator](https://dolphin-emu.org/), extract your game to `orig/G8ME01`.
...
- Configure:
  ...
  To use a version other than `G8ME01` (USA), specify it with `--version`.
- Build:
