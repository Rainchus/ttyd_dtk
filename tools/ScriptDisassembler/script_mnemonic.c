...
OpcodeIDAndString dtk_mnemonic[] = {
    ...
    {6, -1, "EVT_END_LOOP"},
    {7, 0, "EVT_BREAK_LOOP"},
    {8, 0, "EVT_CONTINUE_LOOP"},
    {9, 0, "EVT_WAIT_SECONDS"},
    {10, 0, "EVT_WAIT"},
    {11, 0, "EVT_WAIT_UNTIL"},
    {12, 1, "EVT_IF_STR_EQ"},
    {13, 1, "EVT_IF_STR_NE"},
    {14, 1, "EVT_IF_STR_LT"},
    {15, 1, "EVT_IF_STR_GT"},
    {16, 1, "EVT_IF_STR_LT_OR_EQ"},
    {17, 1, "EVT_IF_STR_GT_OR_EQ"},
    {18, 1, "EVT_IF_FLOAT_EQ"},
    {19, 1, "EVT_IF_FLOAT_NE"},
    {20, 1, "EVT_IF_FLOAT_LT"},
    {21, 1, "EVT_IF_FLOAT_GT"},
    {22, 1, "EVT_IF_FLOAT_LT_OR_EQ"},
    {23, 1, "EVT_IF_FLOAT_GT_OR_EQ"},
    {24, 1, "EVT_IF_INT_EQ"},
    {25, 1, "EVT_IF_INT_NE"},
    {26, 1, "EVT_IF_INT_LT"},
    {27, 1, "EVT_IF_INT_GT"},
    {28, 1, "EVT_IF_INT_LT_OR_EQ"},
    {29, 1, "EVT_IF_INT_GT_OR_EQ"},
    {30, 1, "if_bits_set"},
    {31, 1, "if_bits_clear"},
    {32, -1, "EVT_ELSE"},
    {33, -1, "EVT_END_IF"},
    {34, 1, "EVT_SWITCH"},
    {35, 1, "EVT_SWITCH_CONST"}, //unused
    {36, 0, "EVT_CASE_INT_EQ"},
    {37, 0, "EVT_CASE_INT_NE"},
    {38, 0, "EVT_CASE_INT_LT"},
    {39, 0, "EVT_CASE_INT_GT"},
    {40, 0, "EVT_CASE_INT_LT_OR_EQ"},
    {41, 0, "EVT_CASE_INT_GT_OR_EQ"},
    {42, 0, "EVT_CASE_DEFAULT"},
    {43, 0, "EVT_CASE_OR_EQ"},
    {44, 0, "EVT_CASE_AND_EQ"},
    {45, 0, "EVT_CASE_FLAG"},
    {46, 0, "EVT_END_CASE_GROUP"},
    {47, 0, "EVT_CASE_RANGE"},
    {48, 0, "EVT_BREAK_SWITCH"},
    {49, -1, "EVT_END_SWITCH"},
    {50, 0, "EVT_SET"},
    {51, 0, "EVT_SET_CONST"},
    {52, 0, "EVT_SETF"},
    ...
    {73, 0, "EVT_FBUF_PEEK"},
    {74, 0, "EVT_USE_ARRAY"},
    {75, 0, "EVT_USE_FLAG_ARRAY"},
    {76, 0, "EVT_MALLOC_ARRAY"},
    {77, 0, "EVT_BITWISE_AND"},
    {78, 0, "EVT_BITWISE_AND_CONST"},
    {79, 0, "EVT_BITWISE_OR"},
    {80, 0, "EVT_BITWISE_OR_CONST"},
    {81, 0, "cvt_ms_f"},
    {82, 0, "cvt_f_ms"},
    {83, 0, "storei"},
    {84, 0, "storef"},
    ...
    {91, 0, "EVT_CALL"},
    {92, 0, "EVT_EXEC_WAIT"},
    {93, 0, "EVT_EXEC_GET_TID"},
    {94, 0, "EVT_EXEC"},
    {95, 0, "EVT_KILL_THREAD"},
    {96, 0, "EVT_JUMP"},
    {97, 0, "EVT_SET_PRIORITY"},
    {98, 0, "set_thread_quantum"},
    {99, 0, "set_thread_type_mask"},
    {100, 0, "EVT_SUSPEND_GROUP"},
    {101, 0, "EVT_RESUME_GROUP"},
    {102, 0, "EVT_SUSPEND_OTHERS"},
    {103, 0, "EVT_RESUME_OTHERS"},
    {104, 0, "EVT_SUSPEND_THREAD"},
    {105, 0, "EVT_SUSPEND_THREAD"},
    {106, 0, "EVT_IS_THREAD_RUNNING"},
    {107, 1, "EVT_THREAD"},
    {108, 1, "begin_thread_tid"},
    {109, -1, "EVT_END_THREAD"},
    {110, 1, "EVT_CHILD_THREAD"},
    {111, 1, "EVT_CHILD_THREAD_TID"},
    {112, -1, "EVT_END_CHILD_THREAD"},
    {113, 0, "debug_put_msg"}, //original name
    {114, 0, "debug_put_reg"}, //original name
    {115, 0, "dbg_expr_to_string"},
    {116, 0, "debug_name"}, //original name
