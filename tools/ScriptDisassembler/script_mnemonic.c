...
OpcodeIDAndString dtk_mnemonic[] = {
    ...
    {76, 0, "MALLOC_ARRAY"},
    {77, 0, "BITWISE_AND"},
    {78, 0, "BITWISE_AND_CONST"},
    {79, 0, "BITWISE_OR"},
    {80, 0, "BITWISE_OR_CONST"},
    {81, 0, "cvt_ms_f"},
    {82, 0, "cvt_f_ms"},
    {83, 0, "storei"},
    {84, 0, "storef"},
    ...
    {100, 0, "SUSPEND_GROUP"},
    {101, 0, "RESUME_GROUP"},
    {102, 0, "SUSPEND_OTHERS"},
    {103, 0, "RESUME_OTHERS"},
    {104, 0, "SUSPEND_THREAD"},
    {105, 0, "SUSPEND_THREAD"},
    {106, 0, "IS_THREAD_RUNNING"},
    {107, 1, "THREAD"},
    {108, 1, "begin_thread_tid"},
    {109, -1, "END_THREAD"},
    {110, 1, "CHILD_THREAD"},
    {111, 1, "CHILD_THREAD_TID"},
    {112, -1, "END_CHILD_THREAD"},
    {113, 0, "debug_put_msg"}, //original name
    {114, 0, "debug_put_reg"}, //original name
    {115, 0, "dbg_expr_to_string"},
